...
const interRegularFontP = fetch(
  new URL('../../public/fonts/PretendardStd-Regular.otf', import.meta.url)
).then((res) => res.arrayBuffer())

const interBoldFontP = fetch(
  new URL('../../public/fonts/PretendardStd-SemiBold.otf', import.meta.url)
).then((res) => res.arrayBuffer())
    ...
    (
      <div
        style={{
          ...
          fontFamily: '"PretendardStd", sans-serif',
          color: 'black'
        }}
      >
        {pageInfo.image && (
